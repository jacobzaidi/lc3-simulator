...
void printRegisters(){
    ...
    for (i = 0; i < 8; i++){
        std::cout << "R" << i << "\t0x";
        std::cout << std::setfill('0') << std::setw(4) << std::hex << registerR[i];
        std::cout << "\n";
    }
    std::cout << "PC\t0x";
    std::cout << std::setfill('0') << std::setw(4) << std::hex << registerPC;
    std::cout << "\nIR\t0x";
    std::cout << std::setfill('0') << std::setw(4) << std::hex << registerIR;
    std::cout << "\nCC\t" << registerCC << "\n==================\n";
}
